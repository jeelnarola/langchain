...
async def build_tool_finder_prompt(tools_schema: str, user_memory: str = "", recent_history: str = ""):
    """
    ...
    mcp_tools = await format_mcp_tools()
...
# ------------------------ PROMPT 2 ------------------------
async def build_tool_prompt(tool_info):
